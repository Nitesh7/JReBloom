...
//
//    private static HostAndPort nodeInfo1 = new HostAndPort("127.0.0.1", 30001);
//    private static HostAndPort nodeInfo2 = new HostAndPort("127.0.0.1", 30002);
//    private static HostAndPort nodeInfo3 = new HostAndPort("127.0.0.1", 30003);
